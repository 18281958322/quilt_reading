<template>
  <div class="OAOU_AnnouncementOfTheManagement">
    ...
    >
      ...
      <div @click="openPage('/addOAOU_AnnouncementOfTheManagement')" class="isbutton bt1">
        新增公告
      </div>
    </div>
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          ...
          >
          <a
            @click="openPage('/setOAOU_AnnouncementOfTheManagement')"
...
<style lang="scss">
.OAOU_AnnouncementOfTheManagement {
}
</style>
