<template>
  <div class="OAOU_ImgTextNavigation">
    ...
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="图文导航" name="first">
        ...
        >
          ...
          <div @click="openPage('/addOAOU_ImgTextNavigation')" class="isbutton bt1">
            新增图文导航
          </div>
        </div>
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              ...
              >
              <a
                @click="openPage('/setOAOU_ImgTextNavigation')"
      ...
      <el-tab-pane label="自定义子页面" name="second">
        ...
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <a
                @click="openPage('/OAO_itn_manageBooks')"
                style="margin-left: 4px; color: #00a5ff; font-size: 12px"
                href="javascript:void(0)"
                >管理书籍</a
              >
