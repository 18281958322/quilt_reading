<template>
  <div class="OAO_recharge">
    <div class="pagetitle">充值套餐</div>
    <div class="OAO_recharge_header">
      <div>1. 充值书币数=单位充值比例*价格</div>
    </div>
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="充值套餐" name="first">
        <div
          style="margin: 0 0 20px"
          class="flex align-center OAO_rechargeHeader justify-between"
        >
          <div class="flex">
            <el-input
          ...
          <div class="flex align-center">
            <div class="isbutton bt5">
              充值比例
            </div>
            <div
              @click="openPage('/addOAO_recharge')"
        ...
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              ...
              <a
                @click="openPage('/setOAO_recharge')"
        ...
        <div class="flex justify-between OAO_rechargeBottom align-center">
          <div @click="open('确定删除选中充值套餐么？')" class="isbutton bt0">
            批量删除
          </div>
          <el-pagination
