<template>
  <div class="PCOU_RecommendedWork">
    <div class="pagetitle">推荐作品</div>
    <div
    ...
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column label="作品封面"></el-table-column>
    ...
    <el-dialog title="新增推荐位作品" :visible.sync="dialogVisible" width="450px">
      <el-form
        :model="form"
        :rules="rules"
        ref="ruleForm"
