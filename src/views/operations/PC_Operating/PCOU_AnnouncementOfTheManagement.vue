<template>
  <div class="PCOU_AnnouncementOfTheManagement">
    <div class="pagetitle">公告管理</div>
    <div class="PCOU_Announcement_header">
      <div>
        展示在首页，Banner图右侧，如图： <a href="http://www.oicqzone.com/tool/emoji/">公告示例图</a>
      </div>
    </div>
    <div
      style="margin: 20px 0"
    ...
    >
      <div class="flex">
        <el-input style="width: 150px" placeholder="标题" clearable v-model="value"></el-input>
        <div style="margin: 0 0 0 10px" class="isbutton bt1">搜索</div>
      </div>
      <div @click="openPage('/addPCOU_Announcement')" class="isbutton bt1">
        新增公告
      </div>
    </div>
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column label="跳转类型"></el-table-column>
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          ...
          >
          <a
            @click="openPage('/setPCOU_Announcement')"
    ...
    <div class="flex justify-between GO_rankingListBottom align-center">
      <div @click="open('确定删除选中公告么？')" class="isbutton bt0">
        批量删除
      </div>
      <el-pagination
...
<style lang="scss">
.PCOU_AnnouncementOfTheManagement {
}
</style>
