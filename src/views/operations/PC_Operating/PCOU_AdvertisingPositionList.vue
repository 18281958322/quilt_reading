<template>
  <div class="OAOU_AdvertisingPositionList">
    <div class="pagetitle">首页广告列表</div>
    <div
    ...
    >
      ...
      <div @click="openPage('/addAdvertising_PCOU')" class="isbutton bt1">新增广告</div>
    </div>
    <el-table :data="tableData" border style="width: 100%">
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          <a
            @click="openPage('/setAdvertising_PCOU')"
    ...
    <div class="flex justify-between GO_rankingListBottom align-center">
      <div @click="open('确定删除选中广告么？')" class="isbutton bt0">
        批量删除
      </div>
      <el-pagination
